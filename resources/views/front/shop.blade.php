                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-check mb-2">
                            <input {{(in_array($brand->id,$brandsArray))?'checked':''}} class="form-check-input
                            brand-label" name="brand[]" type="checkbox"
                        ...
                        <div class="d-flex align-items-center justify-content-end mb-4">
                            <div class="ml-2">
                                ...
                                <select name="sort" id="sort" class="form-control">
                                    ...
                                    <option value="price_desc" {{($sort =='price_desc' ) ?'selected':''}}> PriceHigh</option>
                    ...
                    <div class="col-md-4">
                        <div class="card product-card">
                            ...
                            <div class="card-body text-center mt-3">
                                <a class="h6 link" href="{{route('products.getProduct')}}">{{$product->title}}</a>
...
@section('customJs')
<script>
        // range slider library of price filter
