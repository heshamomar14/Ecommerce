                            ...
                            <div class="card-body p-4">
                                <div class="row">
                                    ...
                                    <div  class="col-md-6 mb-3">
                                        ...
                                        <textarea type="text" name="address" id="address" cols="3" rows="3" class="form-control">{{(!empty($customerAddress))?$customerAddress->address:''}}</textarea>
                                        <p></p>
                                    </div>
                                    <div class=" col-md-6 mb-3">
                                        <label for="phone">apartment</label>
                                        <textarea type="text" name="apartment" id="apartment" cols="3" rows="3" class="form-control">{{(!empty($customerAddress))?$customerAddress->apartment:''}}</textarea>
                                        <p></p>
                                    </div>
                                    <div class=" col-md-6 mb-3">
                                        <label for="phone">state</label>
                                        <textarea type="text" name="state" id="state" cols="3" rows="3" class="form-control">{{(!empty($customerAddress))?$customerAddress->state:''}}</textarea>
                                        <p></p>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="phone">city</label>
                                        <textarea type="text" name="city" id="city" cols="3" rows="3" class="form-control">{{(!empty($customerAddress))?$customerAddress->city:''}}</textarea>
                                        <p></p>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="phone">zip</label>
                                        <textarea type="text" name="zip" id="zip" cols="3" rows="3" class="form-control">{{(!empty($customerAddress))?$customerAddress->zip:''}}</textarea>
                                        <p></p>
                                    </div>
                                    <div class="d-flex">
                                        <button class="btn btn-dark">Update</button>
