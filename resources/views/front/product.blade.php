                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <p class="rating_errors text-danger"></p>
                                    </div>
                                    <div class="form-group mb-3">
                ...
                <div class="card product-card">
                    <div class="product-image position-relative">
                        <a href="" class="product-img">
                            ...
                            <img class="card-img-top" src="{{asset('uploads/product/large/'.$productImage->image)}}" width="100" >
                            @else
                            <img src="{{asset('admin-assets/img/default-150x150.png')}}" />
                            @endif
                        </a>
                        <a onclick="addToWishlists({{$relatedProduct->id}})" class="whishlist" href="javascript:void(0);"><i class="far fa-heart"></i></a>
                    ...
                    if (response['status'] == true) {
                        ...
                        if (errors['username']) {
                            $('#username').addClass('is-invalid')
                                .siblings('p').addClass('invalid-feedback').html(errors['username']);
                        } else {
                        ...
                        if (errors['rating']) {
                            $('#rating_errors').addClass('is-invalid')
                                .siblings('p').addClass('invalid-feedback').html(errors['rating']);
                        } else {
                            $('#rating_errors').removeClass('is-invalid').siblings('p').removeClass('invalid-feedback').html("");
                        }
                        if (errors['comment']) {
                            $('#comment').addClass('is-invalid')
                                .siblings('p').addClass('invalid-feedback').html(errors['comment']);
                        } else {
