                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <input type="text" name="apartment" id="apartment" class="form-control"
                                                   placeholder="Apartment, suite, unit, etc. (optional) {{(!empty($customerAddress))?$customerAddress->apartment:''}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <input type="text" name="city" id="city" class="form-control"
                                                   placeholder="City" {{(!empty($customerAddress))?$customerAddress->city:''}}>
                                            <p></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <input type="text" name="state" id="state" class="form-control"
                                                   placeholder="State" {{(!empty($customerAddress))?$customerAddress->state:''}}>
                                            <p></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <input type="text" name="zip" id="zip" class="form-control"
                                                   placeholder="Zip" {{(!empty($customerAddress))?$customerAddress->zip:''}}>
                                            <p></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <input type="text" name="mobile" id="mobile" class="form-control"
                                                   placeholder="Mobile No." {{(!empty($customerAddress))?$customerAddress->mobile:''}}>
                        ...
                        <div class="card cart-summery">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between mt-2">
                                    ...
                                    <div class="h6"><strong
                                            id="shippingCharge">${{number_format($totalshipping,2)}}</strong></div>
                                </div>
