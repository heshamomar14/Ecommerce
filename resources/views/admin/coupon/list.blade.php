                        ...
                        @if($coupons->isNotEmpty())
                            @foreach($coupons as $coupon)
                                <tr>
                                    ...
                                    <td>{{(!empty($coupon->starts_at))?\Carbon\Carbon::parse($coupon->starts_at)->format('Y/m/d '):''}}</td>
                                    <td>{{(!empty($coupon->expires_at))?\Carbon\Carbon::parse($coupon->expires_at)->format('Y/m/d '):''}}</td>
