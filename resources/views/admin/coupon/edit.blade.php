                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input value="{{$coupon->max_uses}}" type="text" name="max_uses" id="max_uses"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="type" id="type" class="form-control">
                                        <option {{($coupon->type=='percentage')?'selected':''}} value="percentage">
                                            Percentage
                                        </option>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input value="{{$coupon->min_amount}}" type="text" name="min_amount" id="min_amount"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input value="{{$coupon->starts_at}}" autocomplete="off" type="text"
                                           name="starts_at" id="starts_at" class="form-control" placeholder="Start At">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
...
@section('customJs')
    <script>
        $("#discountForm").submit(function (event) {
            ...
            $.ajax({
                url: '{{ route("coupon.update",$coupon->id) }}',  // Use the correct route for POST
                type: 'put',
